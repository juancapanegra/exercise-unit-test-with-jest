...
const fromDollarToYen = function (valueInDollar) {
    ...
    let apoyoEuro = valueInDollar / 1.07 / 1;
...
const fromYenToPound = function (valueInYen) {
    //Nos apoyamos nuevamente primero con la conversión en euro
    let apoyoEuro = valueInYen / 156.5;
    let valueInPound = apoyoEuro * 0.87;
